...
$givenOldPassword = $_POST['oldPassword'];
$givenUserID = $_POST['userID'];

$database = new Database();
$db = $database->getConnection();

$email = getEmailFromUserID($givenUserID);
$verifyPass = verifyPass($email, $givenOldPassword);

if($verifyPass == 0){
    $out['result'] = 0;
    $out['message'] = "Nuværende adgangskode forkert.";
